...
<div class="block">
	...
	<div class="headerblock">
		<div class="title">
			<a href="<?php echo $g_options['siteurl']; ?>"><img src="<?php echo $iconpath; ?>/zozo.png" alt="<?php echo $g_options['sitename']; ?>" title="<?php echo $g_options['sitename']; ?>" /></a>
		</div>
...
?>
		<div class="headertabs">
			<ul>
<?php
				if ($g_options['siteurl'])
				{
					echo '<li><a href="' . $g_options['siteurl'] . '"><img src="' . $iconpath . '/title-mainsite.png" alt="' . $g_options['sitename'] . '" /></a></li>';
				}
?>
...
<?php
		// FEAT-0029 phase 2, founder decision #4: the style selector
		// dropdown is not rendered in the zozo_dark chrome ("always dark").
		// The engine switch mechanism (URL / cookie / ?style=) stays intact.
?>
	</div>
...
?>    
		<span class="fHeading">&nbsp;<img src="<?php echo IMAGE_PATH; ?>/downarrow.gif" alt="" />&nbsp;<?=__('common.nav.menu')?></span><p />
		<ul class="navbar">
			<li><a href="<?php echo $g_options['scripturl'] . "?game=$game"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-servers.png" alt="<?=__('common.nav.servers')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?game=$game"; ?>" class="fHeading"><?=__('common.nav.servers')?></a></li>

<?php
	if ($g_options['nav_globalchat']==1) {
?>
			<li><a href="<?php echo $g_options['scripturl'] . "?mode=chat&amp;game=$game"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-chat.png" alt="<?=__('common.nav.chat')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?mode=chat&amp;game=$game"; ?>" class="fHeading"><?=__('common.nav.chat')?></a></li>
<?php
	}
?>
			<li><a href="<?php echo $g_options['scripturl'] . "?mode=players&amp;game=$game"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-players.png" alt="<?=__('common.nav.players')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?mode=players&amp;game=$game"; ?>" class="fHeading"><?=__('common.nav.players')?></a></li>
			<li><a href="<?php echo $g_options['scripturl'] . "?mode=clans&amp;game=$game"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-clans.png" alt="<?=__('common.nav.clans')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?mode=clans&amp;game=$game"; ?>" class="fHeading"><?=__('common.nav.clans')?></a></li>

<?php
	if ($g_options["countrydata"]==1) {
?>
			<li><a href="<?php echo $g_options['scripturl'] . "?mode=countryclans&amp;game=$game&amp;sort=nummembers"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-countryclans.png" alt="<?=__('common.nav.countries')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?mode=countryclans&amp;game=$game&amp;sort=nummembers"; ?>" class="fHeading"><?=__('common.nav.countries')?></a></li>
<?php
	}
?>
			<li><a href="<?php echo $g_options['scripturl'] . "?mode=awards&amp;game=$game"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-awards.png" alt="<?=__('common.nav.awards')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?mode=awards&amp;game=$game"; ?>" class="fHeading"><?=__('common.nav.awards')?></a></li>
<?php
	// look for actions
	$db->query("SELECT game FROM hlstats_Actions WHERE game='".$game."' LIMIT 1");
	if ($db->num_rows()>0) {
?>
			<li><a href="<?php echo $g_options['scripturl'] . "?mode=actions&amp;game=$game"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-actions.png" alt="<?=__('common.nav.actions')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?mode=actions&amp;game=$game"; ?>" class="fHeading"><?=__('common.nav.actions')?></a></li>
<?php
	}
?>
			<li><a href="<?php echo $g_options['scripturl'] . "?mode=weapons&amp;game=$game"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-weapons.png" alt="<?=__('common.nav.weapons')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?mode=weapons&amp;game=$game"; ?>" class="fHeading"><?=__('common.nav.weapons')?></a></li>
			<li><a href="<?php echo $g_options['scripturl'] . "?mode=maps&amp;game=$game"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-maps.png" alt="<?=__('common.nav.maps')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?mode=maps&amp;game=$game"; ?>" class="fHeading"><?=__('common.nav.maps')?></a></li>
<?php
	$result = $db->query("SELECT game from hlstats_Roles WHERE game='$game' AND hidden = '0'");
	$numitems = $db->num_rows($result);
	if ($numitems > 0) {
?>
			<li><a href="<?php echo $g_options['scripturl'] . "?mode=roles&amp;game=$game"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-roles.png" alt="<?=__('common.nav.roles')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?mode=roles&amp;game=$game"; ?>" class="fHeading"><?=__('common.nav.roles')?></a></li>
<?php
	}
	if ($g_options['nav_cheaters'] == 1) {
?>
			<li><a href="<?php echo $g_options['scripturl'] . "?mode=bans&amp;game=$game"; ?>" class="fHeading"><img src="<?php echo $iconpath; ?>/nav-bans.png" alt="<?=__('common.nav.bans')?>" /></a> <a href="<?php echo $g_options['scripturl'] . "?mode=bans&amp;game=$game"; ?>" class="fHeading"><?=__('common.nav.bans')?></a></li>
<?php
	}
?>
		</ul>
