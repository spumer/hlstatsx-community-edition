...
return [
    ...
    'common.col.rank_title'  => 'Title',
    // zozo_dark theme redesign labels (VRTF r1 batch, RU from approved mockups)
    'game.kpi.players_in_base'  => 'Players in database',
    'game.kpi.total_kills'      => 'Total kills',
    'game.kpi.servers_online'   => 'Servers online',
    'game.kpi.players_online'   => 'Players online',
    'game.kpi.sub.new_24h'      => '%s in 24h',
    'game.kpi.sub.maps_rotation' => 'maps in rotation: %s',
    'game.kpi.sub.peak_24h'     => '24h peak: %s',
    'game.col.connect'          => 'Connect',
    'game.panel.top_players'    => 'Top players',
    'game.link.full_ranking'    => 'Full ranking',
    'game.panel.activity_24h'   => '24h activity',
    'playerinfo.rank.max'       => 'Max rank reached',
    'players.filter.period'     => 'Period',
    'players.filter.sort'       => 'Sort',
    'players.filter.apply'      => 'Apply',
    'players.filter.clear'      => 'Clear filters',
    'players.search.placeholder' => 'Nickname or SteamID…',
    'playerinfo.tile.sub.kpm'   => '%s per min',
    'playerinfo.tile.sub.suicides' => 'suicides: %s',
    ...
    'playerinfo.elo.title'      => 'Skill Rating ELO (skill.zozo.gg)',
    'playerinfo.elo.calibrating' => 'calibrating',
    'playerinfo.elo.rank'       => '#%s of %s',
