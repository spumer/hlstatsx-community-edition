...
return [
    ...
    // Fresh translation, not confirmed against zozo's actual prod wording
    // -- see en.php comment above these same keys.
    ...
    'playerhistory.event_type.team_bonus'   => 'Командный бонус',
    'playerhistory.event_type.connect'      => 'Подключение',
    'playerhistory.event_type.disconnect'   => 'Отключение',
    'playerhistory.event_type.entry'        => 'Вход',
    'playerhistory.event_type.kill'         => 'Убийство',
    'playerhistory.event_type.death'        => 'Смерть',
    'playerhistory.event_type.team_kill'    => 'Тимкилл',
    'playerhistory.event_type.friendly_fire' => 'Дружественный огонь',
    ...
    'playerhistory.event.team_bonus.pre'    => 'Моя команда получила бонус очков ',
    'playerhistory.event.suffix.for_triggering' => ' за срабатывание "',
    'playerhistory.event.suffix.closing_quote'  => '"',
    'playerhistory.event.connected'         => 'Я подключился к серверу',
    'playerhistory.event.disconnected'      => 'Я покинул игру',
    'playerhistory.event.entered'           => 'Я вошёл в игру',
    ...
    'playerhistory.event.team_kill.pre'     => 'Я убил тиммейта ',
    'playerhistory.event.friendly_fire.pre' => 'Мой тиммейт ',
    'playerhistory.event.role.pre'          => 'Я сменил роль на ',
    'playerhistory.event.name.pre'          => 'Я сменил имя с "',
    'playerhistory.event.name.mid'          => '" на "',
    'playerhistory.event.action.pre'        => 'Я получил бонус очков ',
    'playerhistory.event.action.quote_against' => '" против ',
    'playerhistory.event.action.triggered_quote' => ' активировал "',
    'playerhistory.event.action.quote_against_me' => '" против меня',
    'playerhistory.event.suicide.pre'       => 'Я совершил самоубийство с помощью "',
    'playerhistory.event.team.pre'          => 'Я вступил в команду "',
