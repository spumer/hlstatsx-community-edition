...
return [
    ...
    'common.col.rank_title'  => 'Звание',
    // zozo_dark theme redesign labels (VRTF r1 batch, RU дословно из утв. макетов)
    'game.kpi.players_in_base'  => 'Игроков в базе',
    'game.kpi.total_kills'      => 'Убийств всего',
    'game.kpi.servers_online'   => 'Серверов онлайн',
    'game.kpi.players_online'   => 'Игроков онлайн',
    'game.kpi.sub.new_24h'      => '%s за 24 часа',
    'game.kpi.sub.maps_rotation' => 'карт в ротации: %s',
    'game.kpi.sub.peak_24h'     => 'пик за сутки: %s',
    'game.col.connect'          => 'Подключиться',
    'game.panel.top_players'    => 'Топ игроки',
    'game.link.full_ranking'    => 'Весь рейтинг',
    'game.panel.activity_24h'   => 'Активность за 24 часа',
    'playerinfo.rank.max'       => 'Достигнут максимум',
    'players.filter.period'     => 'Период',
    'players.filter.sort'       => 'Сортировка',
    'players.filter.apply'      => 'Применить',
    'players.filter.clear'      => 'Очистить фильтры',
    'players.search.placeholder' => 'Ник или SteamID…',
    'playerinfo.tile.sub.kpm'   => '%s в мин',
    'playerinfo.tile.sub.suicides' => 'суицидов: %s',
    ...
    'playerinfo.elo.label'      => 'ELO',
    'playerinfo.elo.title'      => 'Рейтинг мастерства ELO (skill.zozo.gg)',
    'playerinfo.elo.calibrating' => 'калибруется',
    'playerinfo.elo.rank'       => '#%s из %s',
    ...
    // RU values are zozo's actual production wording, pulled from
    // E:/sources/zozo/hlstatsx/web/pages/playerhistory.php (same source
    // used for every other batch in this catalog), mapped by eventType.
    // event_type.team_bonus has NO entry here on purpose: zozo's own
    // source leaves 'Team Bonus' untranslated (falls back to en.php),
    // same as the disputed-terminology precedent (heatmap,
    // player_list_fallback) -- not an oversight.
    ...
    'playerhistory.event_type.connect'      => 'Подключился',
    'playerhistory.event_type.disconnect'   => 'Отключился',
    'playerhistory.event_type.entry'        => 'Вход',
    'playerhistory.event_type.kill'         => 'Убийства',
    'playerhistory.event_type.death'        => 'Смерти',
    'playerhistory.event_type.team_kill'    => 'Тимкилл',
    'playerhistory.event_type.friendly_fire' => 'Стрельба по Своим',
    'playerhistory.event_type.role'         => 'Роль',
    'playerhistory.event_type.name'         => 'Имя',
    'playerhistory.event_type.action'       => 'Действие',
    'playerhistory.event_type.suicide'      => 'Самоубийство',
    'playerhistory.event_type.team'         => 'Команда',
    'playerhistory.event.team_bonus.pre'    => 'Моя команда получила ',
    'playerhistory.event.suffix.for_triggering' => ' бонусных очков за "',
    'playerhistory.event.suffix.closing_quote'  => '"',
    'playerhistory.event.connected'         => 'Я подключился к серверу',
    'playerhistory.event.disconnected'      => 'Я вышел из игры',
    'playerhistory.event.entered'           => 'Я зашел в игру',
    'playerhistory.event.kill.pre'          => 'Я убил ',
    'playerhistory.event.suffix.with_weapon' => ' из ',
    'playerhistory.event.kill_headshot.with_weapon' => ' хедшотом из ',
    'playerhistory.event.suffix.killed_me_with' => ' убил меня из ',
    'playerhistory.event.team_kill.pre'     => 'Я убил члена команды ',
    'playerhistory.event.friendly_fire.pre' => 'Член моей команды ',
    'playerhistory.event.role.pre'          => 'Я поменял роль на ',
    'playerhistory.event.name.pre'          => 'Я поменял свое имя с "',
    'playerhistory.event.name.mid'          => '" на "',
    'playerhistory.event.action.pre'        => 'Я получил ',
    'playerhistory.event.action.quote_against' => '" против ',
    'playerhistory.event.action.triggered_quote' => ' совершил "',
    'playerhistory.event.action.quote_against_me' => '" против меня',
    'playerhistory.event.suicide.pre'       => 'Я убил себя из "',
    'playerhistory.event.team.pre'          => 'Я присоединился к команде "',
    ...
    'playerinfo_general.alt.history'          => 'История',
    'playerinfo_general.label.player_history' => 'История игрока <b>%s</b>:',
    ...
    'playerinfo_general.title.forum_sig'      => 'Скопируйте и вставьте всю ссылку ниже в подпись форума',
    'playerinfo_general.alt.forum_sig_image'  => 'изображение подписи форума',
